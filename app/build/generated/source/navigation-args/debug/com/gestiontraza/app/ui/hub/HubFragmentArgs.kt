...
public data class HubFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HubFragmentArgs {
      bundle.setClassLoader(HubFragmentArgs::class.java.classLoader)
      ...
      return HubFragmentArgs(__caravanas)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): HubFragmentArgs {
      val __caravanas : String?
