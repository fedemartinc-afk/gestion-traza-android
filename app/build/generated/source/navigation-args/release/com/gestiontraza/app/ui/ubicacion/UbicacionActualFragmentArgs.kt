...
public data class UbicacionActualFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): UbicacionActualFragmentArgs {
      bundle.setClassLoader(UbicacionActualFragmentArgs::class.java.classLoader)
      ...
      return UbicacionActualFragmentArgs(__caravanas)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        UbicacionActualFragmentArgs {
      val __caravanas : String?
