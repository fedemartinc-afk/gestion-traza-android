...
public data class EstadoPredespachoFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EstadoPredespachoFragmentArgs {
      bundle.setClassLoader(EstadoPredespachoFragmentArgs::class.java.classLoader)
      ...
      return EstadoPredespachoFragmentArgs(__caravanas)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        EstadoPredespachoFragmentArgs {
      val __caravanas : String?
