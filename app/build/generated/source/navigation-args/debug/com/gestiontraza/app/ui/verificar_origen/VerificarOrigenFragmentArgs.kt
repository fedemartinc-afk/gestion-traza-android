...
public data class VerificarOrigenFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): VerificarOrigenFragmentArgs {
      bundle.setClassLoader(VerificarOrigenFragmentArgs::class.java.classLoader)
      ...
      return VerificarOrigenFragmentArgs(__caravanas)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        VerificarOrigenFragmentArgs {
      val __caravanas : String?
