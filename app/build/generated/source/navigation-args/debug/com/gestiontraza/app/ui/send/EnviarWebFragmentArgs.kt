...
public data class EnviarWebFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EnviarWebFragmentArgs {
      bundle.setClassLoader(EnviarWebFragmentArgs::class.java.classLoader)
      ...
      return EnviarWebFragmentArgs(__caravanas)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): EnviarWebFragmentArgs {
      val __caravanas : String?
