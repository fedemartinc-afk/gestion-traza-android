...
public data class ImportarEditarSesionFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): ImportarEditarSesionFragmentArgs {
      bundle.setClassLoader(ImportarEditarSesionFragmentArgs::class.java.classLoader)
      ...
      return ImportarEditarSesionFragmentArgs(__rutaArchivo)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        ImportarEditarSesionFragmentArgs {
      val __rutaArchivo : String?
